...
- Alerts and facilities skills: **router branches and stub nodes only.** A real query returns "that's coming in a later version." The router must still classify them correctly.
